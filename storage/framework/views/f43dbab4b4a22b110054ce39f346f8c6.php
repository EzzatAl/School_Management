...
} elseif ($_instance->childHasBeenRendered('9e8EXPR')) {
    $componentId = $_instance->getRenderedChildComponentId('9e8EXPR');
    $componentTag = $_instance->getRenderedChildComponentTagName('9e8EXPR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9e8EXPR');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('9e8EXPR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('9E8V2eY')) {
    $componentId = $_instance->getRenderedChildComponentId('9E8V2eY');
    $componentTag = $_instance->getRenderedChildComponentTagName('9E8V2eY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9E8V2eY');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('9E8V2eY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\hp\Desktop\Junior_project3\Junior_project\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>