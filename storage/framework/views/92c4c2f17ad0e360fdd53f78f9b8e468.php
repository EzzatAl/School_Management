...
} elseif ($_instance->childHasBeenRendered('DIAFSvZ')) {
    $componentId = $_instance->getRenderedChildComponentId('DIAFSvZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('DIAFSvZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DIAFSvZ');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('DIAFSvZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\test\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>