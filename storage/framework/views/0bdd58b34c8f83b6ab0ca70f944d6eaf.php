...
} elseif ($_instance->childHasBeenRendered('qth1PQn')) {
    $componentId = $_instance->getRenderedChildComponentId('qth1PQn');
    $componentTag = $_instance->getRenderedChildComponentTagName('qth1PQn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qth1PQn');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('qth1PQn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('0i9Vyi1')) {
    $componentId = $_instance->getRenderedChildComponentId('0i9Vyi1');
    $componentTag = $_instance->getRenderedChildComponentTagName('0i9Vyi1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0i9Vyi1');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('0i9Vyi1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\EZZT SVU\SVU\F22\PR1\project\Junior_project\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>