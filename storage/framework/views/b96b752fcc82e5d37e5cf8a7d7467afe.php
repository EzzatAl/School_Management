...
} elseif ($_instance->childHasBeenRendered('GlMtqoa')) {
    $componentId = $_instance->getRenderedChildComponentId('GlMtqoa');
    $componentTag = $_instance->getRenderedChildComponentTagName('GlMtqoa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GlMtqoa');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('GlMtqoa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('MkHCpxm')) {
    $componentId = $_instance->getRenderedChildComponentId('MkHCpxm');
    $componentTag = $_instance->getRenderedChildComponentTagName('MkHCpxm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MkHCpxm');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('MkHCpxm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\test\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>