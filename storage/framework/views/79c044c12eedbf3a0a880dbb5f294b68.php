...
} elseif ($_instance->childHasBeenRendered('XOlk3fe')) {
    $componentId = $_instance->getRenderedChildComponentId('XOlk3fe');
    $componentTag = $_instance->getRenderedChildComponentTagName('XOlk3fe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XOlk3fe');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('XOlk3fe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\Junior_project3\Junior_project\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>