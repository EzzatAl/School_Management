...
} elseif ($_instance->childHasBeenRendered('7uiCL8Y')) {
    $componentId = $_instance->getRenderedChildComponentId('7uiCL8Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('7uiCL8Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7uiCL8Y');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7uiCL8Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH D:\EZZT SVU\SVU\F22\PR1\project\Junior_project\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>